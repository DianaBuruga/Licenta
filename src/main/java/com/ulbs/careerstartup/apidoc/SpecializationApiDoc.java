...
public interface SpecializationApiDoc {
    ...
    Collection<SpecializationDTO> findByCriteria(@Parameter(description = "List of search criteria", required = true) @Valid @RequestBody List<SearchCriteria> criteria);
