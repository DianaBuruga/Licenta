...
public class JobHistoryService {
    ...
    public JobHistoryDTO saveJobHistory(JobHistoryDTO jobHistoryDTO) throws MalformedURLException {
        ...
        jobHistory.setUser(mapper.userDTOToUser(userService.findByEmail("robert.marinescu@yahoo.com")));
    ...
    public CompanyDTO getCompanyInfo(String website) throws MalformedURLException {
        ...
        return CompanyDTO.builder()
                .name(domain.substring(0, 1).toUpperCase() + domain.substring(1, domain.lastIndexOf('.')))
                .website(website)
                .build();
    }
